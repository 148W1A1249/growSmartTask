...
function UpdateForm(props){
    ...
    const showValues = (formValues)=>{
        var UserName = (formValues.UserName)?formValues.UserName:data.UserName;
        var Gender = (formValues.Gender)?formValues.Gender:data.Gender;
        var Email = (formValues.Email)?formValues.Email:data.Email;
        var Phone = (formValues.Phone)?formValues.Phone:data.Phone;
        var City = (formValues.City)?formValues.City:data.City;
        var Pincode = (formValues.Pincode)?formValues.Pincode:data.Pincode;
        axios({
            method: 'put',
